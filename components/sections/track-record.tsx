...
const STATS = [
  ...
  { value: "6", label: "Hackathon podiums in a year" },
  { value: "5,000+", label: "Advisors served by AI I built at Prudential" },
] as const;

const LINKS = [
  { href: "/projects", label: "The systems" },
  { href: "/career", label: "The career" },
  { href: "/hackathons", label: "The wins" },
