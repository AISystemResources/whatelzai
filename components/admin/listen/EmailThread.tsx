...
interface Email {
  ...
  applications?: {
    id: string;
    status: string;
    job_listings?: { company: string; role: string } | null;
  } | null;
}
            ...
            <div>
              ...
              {selected.applications && (
                <p className="text-xs text-zinc-400 mt-1">
                  Linked: {selected.applications.job_listings?.company} —{" "}
                  {selected.applications.job_listings?.role}(
