...
export const KEYWORD_META: Record<string, KeywordMeta> = {
  ...
  generous: {
    Icon: Heart,
    description: "Gives away time, tools, and know-how freely",
  },
  ...
  perseverance: {
    Icon: Mountain,
    description: "Never try, never know; never give up",
  },
  hardworking: {
    Icon: Hammer,
    description: "Puts in the effort the goal actually needs",
  },
  kind: {
    Icon: Heart,
    description: "Genuinely wants people around him to win",
  },
  reliable: {
    Icon: ShieldCheck,
    description: "You can count on the follow-through",
  },
  authentic: {
    Icon: Feather,
    description: "Real, unrehearsed, honest in the room",
  },
  dependable: { Icon: ShieldCheck, description: "Shows up, closes the loop" },
  responsible: {
    Icon: ClipboardCheck,
    description: "Takes ownership of the work",
  },
  positive: {
    Icon: Sun,
    description: "Uplifting energy in every room he enters",
  },
  energetic: { Icon: Zap, description: "Bring-the-fuel type of collaborator" },
  uplifting: {
    Icon: Sunrise,
    description: "Makes you believe you can do more",
  },
  ...
  composure: {
    Icon: Feather,
    description: "Calm under pressure, not reactive",
  },
  perceptive: { Icon: Eye, description: "Notices what most people miss" },
  objective: {
    Icon: Scale,
    description: "Facts over feelings when it matters",
  },
  methodical: { Icon: Grid3x3, description: "Breaks down chaos into steps" },
  practical: {
    Icon: Wrench,
    description: "Applies theory to what actually ships",
  },
  "deep-thinker": {
    Icon: Brain,
    description: "Sits with a problem until it yields",
  },
  "quality-focused": {
    Icon: Gem,
    description: "'Good enough' isn't in the vocabulary",
  },
  "attention-to-detail": {
    Icon: Search,
    description: "The 1% details others skip",
  },
  craftsmanship: {
    Icon: Hammer,
    description: "Finishing a task isn't doing it well",
  },
  "high-standards": { Icon: Star, description: "Sets the bar, then raises it" },
  "work-ethic": {
    Icon: Hammer,
    description: "Consistent effort, no shortcuts",
  },
  ...
  teaches: {
    Icon: Presentation,
    description: "Turns complex ideas into shared understanding",
  },
  "explains-well": {
    Icon: Presentation,
    description: "Uses analogies that actually land",
  },
  ...
  inquisitive: {
    Icon: Search,
    description: "Asks the question everyone else missed",
  },
  communicator: {
    Icon: MessageSquare,
    description: "Says the thing clearly, first try",
  },
  networking: {
    Icon: Network,
    description: "Turns strangers into genuine connections",
  },
  ideas: { Icon: Lightbulb, description: "Plenty of them, ready to try" },
  researcher: {
    Icon: BookOpen,
    description: "Goes to the source, not the summary",
  },
  ...
  leadership: {
    Icon: Flag,
    description: "Direction, calm, and momentum in one",
  },
  ...
  innovative: {
    Icon: Lightbulb,
    description: "Finds an angle nobody else tried",
  },
  creative: { Icon: Palette, description: "Solves problems the elegant way" },
  "up-to-date": {
    Icon: Clock,
    description: "Current on tools, models, and shifts",
  },
  "bridges-tech-business": {
    Icon: LinkIcon,
    description: "Translates engineering into outcome",
  },

  // Impact (what he causes in others)
  "mindset-shift": {
    Icon: RefreshCw,
    description: "You leave thinking differently",
  },
  clarity: { Icon: Sun, description: "The fog lifts after talking to him" },
  intentional: {
    Icon: Target,
    description: "Deliberate about time and energy",
  },
  "action-oriented": {
    Icon: Rocket,
    description: "Idea → move, no long detour",
  },
  ...
  "self-reflection": {
    Icon: Eye,
    description: "The mirror you didn't know you needed",
  },
  "decision-making": {
    Icon: Scale,
    description: "Cleaner choices, less second-guessing",
  },
  "confidence-building": {
    Icon: ShieldPlus,
    description: "You believe more after working with him",
  },
  impact: {
    Icon: Sparkles,
    description: "The change sticks long after the session",
  },
