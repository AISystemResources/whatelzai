...
`whatelz.ai` — Edmund Lin Zhenming's personal AI-engineer site. Data-driven content (projects, channels, hackathons, blog, career, leadership, mentorship) backed by Supabase, with a gated admin shell, an MCP surface for Claude clients, and an autogenerated multi-version resume / cover-letter pipeline. Full product truth: `projects/WHATELZ-AI/CONTEXT.md`.
