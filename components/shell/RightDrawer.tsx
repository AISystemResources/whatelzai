...
export function RightDrawer() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className={`fixed top-14 right-0 z-30 flex h-[calc(100vh-56px)] w-[360px] flex-col border-l border-zinc-200 bg-[var(--background)] transition-transform duration-200 ${
