...
export const metadata: Metadata = {
  ...
  description:
    "Share honest feedback — praise, thoughts, and things I could improve.",
      ...
      <main className="px-6 py-20 sm:px-8 sm:py-28">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-zinc-600">
            Honest words welcome — the good, the sharp, and anything I could do
            better. Start with your email so I can track your progress and get
            back to you.
          </p>
