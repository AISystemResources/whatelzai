      ...
      {view === "table" ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-zinc-100">
              {channels.map((ch) => (
                ...
                >
                  <td className="py-4 pr-8 font-medium text-zinc-900">
                    {ch.name}
                  </td>
                  <td className="py-4 pr-8 font-mono text-xs text-zinc-500">
                    {ch.handle}
                  </td>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {channels.map((ch) => (
            <div
              key={ch.name}
              className="border border-zinc-200 rounded p-5 space-y-3"
            >
              <div>
